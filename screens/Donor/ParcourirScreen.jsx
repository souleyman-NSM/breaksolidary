// screens/Donor/ParcourirScreen.jsx
...
export default function ParcourirScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <Button title="Ajouter Marqueur" onPress={handleAddMarker} />
      </View>
    </View>
  );
}
